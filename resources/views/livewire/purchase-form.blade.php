...
{{--                    ${{ number_format($subtotal, 2) }}--}}
                {{ auth()->user()->account->currency }}{{($subtotal) }}
                </td>
            </tr>
            <tr>
                <th colspan="4" class="align-middle text-end">
                ...
                <td width="150" class="align-middle text-center">
                    <input wire:model.live.blur="taxes" type="number" id="taxes" class="form-control w-75 d-inline" min="0" max="100">
                    %
            ...
            <tr>
                ...
                <td class="text-center">
                    {{ auth()->user()->account->currency }}{{ ($total) }}
