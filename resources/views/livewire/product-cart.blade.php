    ...
    <div class="row gx-3 mb-3">
        <div class="col">
            ...
            <input type="number"
                   id="tax_percentage"
                   name="tax_percentage"
                   wire:model.live.blur="global_tax"
                   class="form-control"
        ...
        <div class="col">
            ...
            <input wire:model.live.blur="global_discount" type="number" class="form-control" name="discount_percentage" id="discount_percentage" min="0" max="100" value="{{ $global_discount }}" required>
        </div>

        <div class="col">
            <label for="shipping_amount" class="small mb-1">Shipping</label>
            <input wire:model.live.blur="shipping" type="number" class="form-control" name="shipping_amount" id="shipping_amount" min="0" value="0" required step="0.01">
        </div>
    </div>
</div>
