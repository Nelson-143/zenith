            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('purchases.updatePurchase') }}" method="POST">
                        ...
                        <!-- Submit button -->
                        <button type="submit" class="btn btn-success" onclick="return confirm('Are you sure you want to approve this purchase?')">Approve Purchase{{ __('') }}</button>
