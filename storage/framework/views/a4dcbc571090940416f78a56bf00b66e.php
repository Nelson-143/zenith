...
<form class="card card-md" action="<?php echo e(route('register')); ?>" method="POST" autocomplete="off">
    <?php echo csrf_field(); ?>
        ...
        <div class="mb-3">
            <label class="form-check">
                <input type="checkbox" name="terms-of-service" id="terms-of-service"
                       class="form-check-input <?php $__errorArgs = ['terms-of-service'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                ...
                <span class="form-check-label">
                    Agree the <a href="<?php echo e(route('index.route')); ?>" tabindex="-1">
                        terms and policy</a>.
                </span>
            </label>
        </div>
...
<div class="text-center text-secondary mt-3">
    Already have account? <a href="<?php echo e(route('login')); ?>" tabindex="-1">
        Sign in
    </a>
</div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\rstoresV1R\zenith\resources\views/auth/register.blade.php ENDPATH**/ ?>